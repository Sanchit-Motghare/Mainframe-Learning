...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  DEFINE GDG (NAME(Z67429.ASS8.GDGBASE) LIMIT(4) SCRATCH NOEMPTY)
/*
//*---------------------------------------------------------------*
...
/*
//SYSUT2   DD DSN=Z67429.ASS8.GDGBASE(+1),
...
/*
//SYSUT2   DD DSN=Z67429.ASS8.GDGBASE(+2),
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(1,1),RLSE)
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DUMMY
...
/*
//SYSUT2   DD DSN=Z67429.ASS8.GDGBASE(+3),
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(1,1),RLSE)
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DUMMY
...
/*
//SYSUT2   DD DSN=Z67429.ASS8.GDGBASE(+4),
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(1,1),RLSE)
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DUMMY
...
//SYSOUT   DD SYSOUT=*
//SORTJNF1 DD DSN=Z67429.ASS8.GDGBASE(+1),DISP=SHR
//SORTJNF2 DD DSN=Z67429.ASS8.GDGBASE(+4),DISP=SHR
//SORTOUT  DD DSN=Z67429.ASS8.PS14OUT,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(1,1),RLSE)
//SYSIN    DD *
...
//SYSOUT   DD SYSOUT=*
//SORTJNF1 DD DSN=Z67429.ASS8.GDGBASE(+2),DISP=SHR
//SORTJNF2 DD DSN=Z67429.ASS8.GDGBASE(+3),DISP=SHR
//SORTOUT  DD DSN=Z67429.ASS8.PS23OUT,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(1,1),RLSE)
//SYSIN    DD *
  JOINKEYS FILE=F1,FIELDS=(1,1,A)
