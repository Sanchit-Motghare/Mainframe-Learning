...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  DEFINE GDG (NAME(Z67429.TRAN.LOGS) LIMIT(10) SCRATCH NOEMPTY)
/*
//*----------------------------------------------------------------*
...
/*
//SYSUT2   DD DSN=Z67429.TRAN.LOGS(+1),
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  LISTC ENT(Z67429.TRAN.LOGS) ALL
/*
//*----------------------------------------------------------------*
...
//SYSPRINT DD SYSOUT=*
//SYSUT1   DD DSN=Z67429.TRAN.LOGS(-3),DISP=SHR
//         DD DSN=Z67429.TRAN.LOGS(-2),DISP=SHR
//         DD DSN=Z67429.TRAN.LOGS(-1),DISP=SHR
//SYSUT2   DD DSN=Z67429.TRAN.ARCHIVE,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(1,1))
//SYSIN    DD DUMMY
//*----------------------------------------------------------------*
...
//DELGEN1  DD DSN=Z67429.TRAN.LOGS(-3),DISP=(MOD,DELETE,DELETE)
//DELGEN2  DD DSN=Z67429.TRAN.LOGS(-2),DISP=(MOD,DELETE,DELETE)
//DELGEN3  DD DSN=Z67429.TRAN.LOGS(-1),DISP=(MOD,DELETE,DELETE)
