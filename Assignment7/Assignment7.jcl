...
//SYSIN    DD *
  SET MAXCC = 0
  DEFINE CLUSTER (NAME(Z67429.ASS7.KSDS)  -
  INDEXED -
  KEYS(10 0) -
  RECSZ(100 100) -
  TRACKS(1,1) -
  CISZ(4096) -
  FREESPACE(5 5)) -
  DATA (NAME(Z67429.ASS7.KSDS.DATA)) -
  INDEX (NAME(Z67429.ASS7.KSDS.INDEX))
/*
//*---------------------------------------------------------------*
...
//SYSIN    DD *
  REPRO -
    ...
    OUTFILE(OUTFILE)
/*
//INFILE   DD DSN=Z67429.PS.TRAN,DISP=SHR
//OUTFILE  DD DSN=Z67429.ASS7.KSDS,DISP=SHR
//*---------------------------------------------------------------*
//* STEP 4: LISTCAT KSDS
//*---------------------------------------------------------------*
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  LISTC ENT(Z67429.ASS7.KSDS) ALL
/*
